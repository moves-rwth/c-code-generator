...
public class StructTypedefDeclaration implements ITypedefDeclaration {

	private final String name;
	private final LinkedHashMap<String, String> members;
	private final String structDataTypeName;

	public StructTypedefDeclaration(String name, LinkedHashMap<String, String> members, String structDataTypeName) {
		this.name = name;
