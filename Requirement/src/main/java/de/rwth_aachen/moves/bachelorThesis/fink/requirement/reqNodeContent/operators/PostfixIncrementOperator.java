...
public class PostfixIncrementOperator extends OperatorTreeNode {
	public static final int ARGUMENT_COUNT = 1;

	public PostfixIncrementOperator(ImmutableList<FormulaTreeNode> children, boolean isInOutput) {
		super("postfixIncrement", children, isInOutput);
	}

	protected PostfixIncrementOperator(PostfixIncrementOperator other, IVariableReplacer variableReplacer) {
		super(other, variableReplacer);
	}

	protected PostfixIncrementOperator(PostfixIncrementOperator other, ImmutableList<FormulaTreeNode> newChildren) {
	...
	public static SimpleChildExpressionConditioner makeChildExpressionConditioner(int childId, SimpleChildExpressionConditioner parentConditioner, List<SimpleResultingExpressionConditioner> previousChildResultConditioners, IDataTypeContext dataTypeContext) throws UnsatisfiableConstraintsException {
		...
		SimpleChildExpressionConditionerBuilder result = parentConditioner.mathExpr(PostfixIncrementOperator.class, parentConditioner, previousChildResultConditioners);
	...
	public FormulaTreeNode replaceChildren(ImmutableList<FormulaTreeNode> children) {
		return new PostfixIncrementOperator(this, children);
	}
	...
	public CodeTreeNode copyTree(IVariableReplacer variableReplacer) {
		return new PostfixIncrementOperator(this, variableReplacer);
	}
}
