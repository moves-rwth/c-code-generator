...
public class ContinueOperator extends ControlStructureOperator {
	...
	public ContinueOperator(ImmutableList<FormulaTreeNode> children, boolean isInOutput) {
		super("continue", children, isInOutput);
	}

	protected ContinueOperator(ControlStructureOperator other, IVariableReplacer variableReplacer) {
		super(other, variableReplacer);
	}

	protected ContinueOperator(ControlStructureOperator other, ImmutableList<FormulaTreeNode> newChildren) {
	...
	public CodeTreeNode copyTree(IVariableReplacer variableReplacer) {
		return new ContinueOperator(this, variableReplacer);
	}

	@Override
	public FormulaTreeNode replaceChildren(ImmutableList<FormulaTreeNode> children) {
		return new ContinueOperator(this, children);
	}
