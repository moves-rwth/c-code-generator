...
public class IntegerArrayVariable extends ArrayVariable {
	private final List<IntegerVariable> arrayValues;
	private boolean hasValues;

	public IntegerArrayVariable(IMemberContainer parent, DataType datatype, ParameterType parameterType, String name, String internalName, IShadowInformation shadowInformation, List<Integer> arrayDimensions, List<IntegerVariable> members) {
	...
	protected IntegerArrayVariable(IntegerArrayVariable other, IMemberContainer newParent) {
	...
	protected IntegerArrayVariable(IntegerArrayVariable other, String newName, String internalName) {
	...
	protected IntegerArrayVariable(IntegerArrayVariable other, String prefix) {
		super(other, other.getName(), prefix + other.getInternalName());
		this.arrayValues = new ArrayList<>();
		copyAndReparentMembersAndAddPrefix(other.arrayValues, prefix);
	}

	private void copyAndReparentMembers(List<IntegerVariable> input) {
		for (IntegerVariable member : input) {
			final IntegerVariable newMemberVariable = (IntegerVariable) member.replaceParent(this);
			this.arrayValues.add(newMemberVariable);
		}
	}

	private void copyAndReparentMembersAndAddPrefix(List<IntegerVariable> input, String prefix) {
		for (IntegerVariable member : input) {
			final IntegerVariable newMemberVariable = (IntegerVariable) member.replaceParent(this).addNamePrefix(prefix);
			;
			this.arrayValues.add(newMemberVariable);
		}
	}
	...
	public Variable copy() {
		return new IntegerArrayVariable(this, getParent());
	}

	@Override
	public Variable replaceParent(IMemberContainer newParent) {
		return new IntegerArrayVariable(this, newParent);
	}

	@Override
	public Variable rename(String name, String internalName) {
		return new IntegerArrayVariable(this, name, internalName);
	}

	@Override
	public IVariable addNamePrefix(String prefix) {
		return new IntegerArrayVariable(this, this.getName(), prefix + this.getInternalName());
	}
	...
	public boolean equals(Object o) {
		...
		IntegerArrayVariable variable = (IntegerArrayVariable) o;
	...
	public List<IntegerVariable> getArrayValues() {
		return arrayValues;
	}
	...
	public List<IntegerVariable> getArrayEntries() {
