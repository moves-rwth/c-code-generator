...
public class PostfixDecrementOperator extends OperatorTreeNode {
	public static final int ARGUMENT_COUNT = 1;

	public PostfixDecrementOperator(ImmutableList<FormulaTreeNode> children, boolean isInOutput) {
		super("postfixDecrement", children, isInOutput);
	}

	protected PostfixDecrementOperator(PostfixDecrementOperator other, IVariableReplacer variableReplacer) {
		super(other, variableReplacer);
	}

	protected PostfixDecrementOperator(PostfixDecrementOperator other, ImmutableList<FormulaTreeNode> newChildren) {
	...
	public static SimpleChildExpressionConditioner makeChildExpressionConditioner(int childId, SimpleChildExpressionConditioner parentConditioner, List<SimpleResultingExpressionConditioner> previousChildResultConditioners, IDataTypeContext dataTypeContext) throws UnsatisfiableConstraintsException {
		...
		SimpleChildExpressionConditionerBuilder result = parentConditioner.mathExpr(PostfixDecrementOperator.class, parentConditioner, previousChildResultConditioners);
	...
	public FormulaTreeNode replaceChildren(ImmutableList<FormulaTreeNode> children) {
		return new PostfixDecrementOperator(this, children);
	}
	...
	public CodeTreeNode copyTree(IVariableReplacer variableReplacer) {
		return new PostfixDecrementOperator(this, variableReplacer);
	}
}
