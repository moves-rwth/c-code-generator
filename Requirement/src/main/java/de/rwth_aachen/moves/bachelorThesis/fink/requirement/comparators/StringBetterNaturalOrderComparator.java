package de.rwth_aachen.moves.bachelorThesis.fink.requirement.comparators;
...
public class StringBetterNaturalOrderComparator implements Comparator<CharSequence> {
	private static final Pattern PATTERN = Pattern.compile("(\\D*)(\\d*)");

	public StringBetterNaturalOrderComparator() {
	}
